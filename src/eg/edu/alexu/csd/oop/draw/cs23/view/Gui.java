...
public class Gui {
	...
	private int xbegin = 65 , ybegin = 112;
	private int xend = 65 , yend = 112;
	...
	ActionListener actionListener = new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == Enterbtn) {
				d.setParameters(xbegin-65, ybegin-112,xend-65, yend-112, Widthtxt.getText(),
						Heighttxt.getText());
			...
			if(e.getSource() == Applybtn){
				d.setUpdateShape(BorderColor, FillColor, xbegin-65, ybegin-112,
						xend-65, yend-112
						, WidthProptxt.getText(), HeigthProptxt.getText());
				d.DynamicPanel(LayersPanel);
				LayersPanel.validate();
				LayersPanel.repaint();
			}
	...
	private void initialize() {
		...
		selectctbtn.setToolTipText("Selcet");
		img = new ImageIcon(
		...
		controlPanel.setBounds(1080, 97, 272, 189);
		...
		lblNewLabel.setBounds(96, 6, 89, 14);
		...
		Widthtxt.setBounds(62, 26, 90, 22);
		controlPanel.add(Widthtxt);

		Heighttxt = new TextField();
		Heighttxt.setBounds(62, 89, 90, 22);
		controlPanel.add(Heighttxt);

		Enterbtn = new JButton("Enter");
		Enterbtn.setToolTipText("Enter");
		Enterbtn.addActionListener(actionListener);
		Enterbtn.setBounds(96, 157, 89, 23);
		controlPanel.add(Enterbtn);

		BorderColorbtn = new JButton("Border Color");
		BorderColorbtn.setToolTipText("Choose Border Color");
		BorderColorbtn.addActionListener(actionListener);
		BorderColorbtn.setBounds(134, 54, 128, 23);
		controlPanel.add(BorderColorbtn);
		...
		FillColorbtn.setBounds(134, 123, 128, 23);
		controlPanel.add(FillColorbtn);
		...
		propPanel.setBounds(1080, 97, 272, 189);
		...
		WidthProptxt = new JTextField();
		WidthProptxt.setBounds(63, 37, 86, 20);
		propPanel.add(WidthProptxt);
		WidthProptxt.setColumns(10);
		
		HeigthProptxt = new JTextField();
		HeigthProptxt.setBounds(63, 84, 86, 20);
		propPanel.add(HeigthProptxt);
		HeigthProptxt.setColumns(10);
		...
		BorderColorPropbtn = new JButton("Border Color");
		BorderColorPropbtn.setToolTipText("Border Color");
		BorderColorPropbtn.setBounds(173, 37, 89, 23);
		BorderColorPropbtn.addActionListener(actionListener);
		propPanel.add(BorderColorPropbtn);
		
		FillColorPropbtn = new JButton("Fill Color");
		FillColorPropbtn.setToolTipText("Fill Color");
		FillColorPropbtn.setBounds(173, 86, 89, 23);
		FillColorPropbtn.addActionListener(actionListener);
		propPanel.add(FillColorPropbtn);
		
		Applybtn = new JButton("Apply");
		Applybtn.setToolTipText("Apply");
		Applybtn.setBounds(10, 138, 89, 23);
		...
		Removebtn.setBounds(173, 138, 89, 23);
